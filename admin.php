  ...
  <div class="site-wrap">
    ...
    <div class="site-top-icons">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="82" height="82" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd">
            ...
            <path fill="currentColor" d="M13 2.05A10.003 10.003 0 0 1 21.95 11H20a1 1 0 0 0 0 2h1.95c-.501 5.053-4.765 9-9.95 9s-9.449-3.947-9.95-9H4a1 1 0 1 0 0-2H2.05A10.003 10.003 0 0 1 11 2.05V4a1 1 0 0 0 2 0zm4.78 4.17l-4.843 2.465l-.373.197l-.61.31c-.72.37-1.454.772-2.005 1.323c-.971.972-1.089 2.588-.07 3.606c1.018 1.019 2.634.901 3.606-.07c.472-.472.835-1.078 1.162-1.696l.471-.919l.362-.698zm-4.618 4.618l-.112.21l-.113.216c-.209.402-.426.822-.698 1.172l-.168.2c-.278.278-.625.224-.778.071c-.138-.138-.196-.432-.003-.692l.073-.085c.319-.294.724-.526 1.13-.74l.243-.127c.146-.075.29-.15.426-.225"/></g>
        </svg>Dashboard</p>
    </div>
</div>

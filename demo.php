...
function getProductDetails($productId)
{
    ...
    $imageQuery = "SELECT image, image1, image2, image3 FROM product_images WHERE product_id = ?";
...
function addToCart($username, $productName, $quantity, $price)
{
    global $conn;
    $insertSql = "INSERT INTO cart (username, product_name, quantity, total) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($insertSql);
    $stmt->bind_param('ssii', $username, $productName, $quantity, $price);
...
if (isset($_GET['show'])) {
    $proId = $_GET['show'];
    $productData = getProductDetails($proId);
  ...
  #d {
        ...
        <body>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="seller.php" class="btn btn-sm custom-button">
                                                    <span class="icon"><i class="fas fa-solid fa-store"></i></span>Become a
                                                    Seller
                                                </a>
                                            </li>
                            ...
                            <div class="container show">
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="overflow-y: auto;">
                                        ...
                                        <p><strong class="text-primary h3">M.R.P <?php $price ?></strong></p>
                                        
                                        <div class="input-group mb-3" style="max-width: 120px;">
                                            <div class="input-group-prepend">
                                            <button onclick="incrementQuantity()" class="btn btn-secondary" style="padding: 0;"><i class="fas fa-plus"></i></button>
                                            <button onclick="decrementQuantity()" class="btn btn-secondary" style="padding: 0;"><i class="fas fa-minus"></i></button>
                                    ...
                                    <p><a href="cart.php?add_to_cart=<?php echo $proId; ?>" class="btn btn-primary">Add to
                                            Cart</a>
                ...
                <ul>
                    <div class="category-box">
                        ...
                        <ul class="details-list">
                            <li><span class="details-label">Brand: </span><span class="details-value"><?php echo $brand?></span></li>
                            <li><span class="details-label">Name: </span><span class="details-value"><?php echo $name ?></span></li>
                        </ul>
                        ...
                        <ul class="details-list">
                            <li><span class="details-label">Size: </span><span class="details-value"><?php echo $size ?></span></li>
                            <li><span class="details-label">Weight: </span><span class="details-value"><?php echo $weight ?></span>
                            </li>
                        </ul>
                        ...
                        <ul class="details-list">
                            <li><span class="details-label">Connectivity: </span><span class="details-value"><?php echo $connectivity ?>
                                    '</span></li>
                        </ul>
                        ...
                        <ul class="details-list">
                            <li><span class="details-label">In the Box: </span><span class="details-value"><?php echo $inthebox ?>
                                    '</span></li>
                            <li><span class="details-label">Color: </span><span class="details-value"><?php echo $color ?></span></li>
                        </ul>
                    </div>
                </ul>
            </div>
            ...
            <div class="container" id="pl">
                <!-- Add your product specifications HTML here -->
            </div>

...
<style type="text/css">
  ...
  background-image: url('images/backgrnd.jpg'); /* Replace 'your-image-url.jpg' with the actual URL of your background image */
  background-size: cover; /* Adjust to your preferred size, 'cover' will scale the image to cover the entire background */
...
.animated-truck {
  animation: truck 2s linear infinite alternate; /* 'alternate' makes the animation reverse direction */
}
...
.block {
opacity: 0;
transform: translateX(-100%); /* Change translateX to translateY */
transition: opacity 0.5s ease, transform 1s ease;
}

/* Animate each team member with a delay */
.block:nth-child(1) {
animation: slideInFromLeft 2s ease 3s forwards; /* Change animation */
}

.block:nth-child(2) {
animation: slideInFromLeft 2s ease 2s forwards; /* Change animation and delay */
}

.block:nth-child(3) {
animation: slideInFromLeft 2s ease 1s forwards; /* Change animation and delay */
}
...
.slide-in {
  ...
  animation-duration: 0.8s; /* Adjust the duration to control the speed (e.g., 1s for a slow slide) */
  animation-timing-function: ease-in-out; /* Use ease-in-out for a smooth start and end */
  animation-fill-mode: both; /* Keeps the final state of the animation after it ends */

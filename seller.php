...
<head>
    ...
    .styles__KeyWrapper-o5uywd-4 {
        box-sizing: border-box;
        width: 100%;
        /* Set width to auto to adjust to content */
        max-width: 250px;
        margin: 10px;
        display: flex;
        flex-direction: column;
    ...
    <div class="site-wrap">
        ...
        <div class="styles__KpiContainer-o5uywd-0">
            <ul class="styles__KpiList-o5uywd-3">
                <li class="styles__KeyWrapper-o5uywd-4">
                    <img src="https://static-assets-web.flixcart.com/fk-sp-static/images/crore_users_revamp.svg"
                        alt="50 Crore users icon" class="styles__KeyImage-o5uywd-6">
                    <div class="styles__KeyHeader-o5uywd-1">Trusted by many Sellers /<br>Customers</div>
                </li>

                <li class="styles__KeyWrapper-o5uywd-4">
                    <img src="https://static-assets-web.flixcart.com/fk-sp-static/images/wallet-icon.svg"
                        alt="7* days secure &amp; regular payments icon" class="styles__KeyImage-o5uywd-6">
                    <div class="styles__KeyHeader-o5uywd-1">7* days secure &amp; <br>regular payments</div>
                </li>

                <li class="styles__KeyWrapper-o5uywd-4">
                    <img src="https://static-assets-web.flixcart.com/fk-sp-static/images/low-cost-icon.svg"
                        alt="Low cost of doing business icon" class="styles__KeyImage-o5uywd-6">
                    <div class="styles__KeyHeader-o5uywd-1">Low cost<br> of doing business</div>
                </li>

                <li class="styles__KeyWrapper-o5uywd-4">
                    <img src="https://static-assets-web.flixcart.com/fk-sp-static/images/seller-support-icon.svg"
                        alt="One click Seller Support icon" class="styles__KeyImage-o5uywd-6">
                    <div class="styles__KeyHeader-o5uywd-1">One click <br>Seller Support</div>
                </li>

                <li class="styles__KeyWrapper-o5uywd-4">
                    <img src="https://static-assets-web.flixcart.com/fk-sp-static/images/shopping-bag-icon.svg"
                        alt="Access to The Big Billion Days &amp; more icon" class="styles__KeyImage-o5uywd-6">
        ...
        <div id="createAccount" class="styles__ContentContainer-a5s7uc-2 eRDGwz">
            <div class="style__ContentHeader-sc-1c43xqv-6 hJmdef">
                <h2 class="styles__H2-a90kxg-5 style__H2TextWrapper-sc-1c43xqv-1 iANvci" style="color:#7971ea">Create
                    Account</h2>
            ...
            <div class="styles__StepsFlex-a5s7uc-12 jxcCkk">
                <div class="styles__DividerContainer-a5s7uc-9 gaPJoO">
                    <div class="styles__RightContainer-a5s7uc-4 iMXeuI">
                        <div class="styles__Container-a5s7uc-5 bOSNXD">
                            <div class="styles__ContentParaContainer-a5s7uc-7 leFggZ">
                                <p>Creating your Electro-Kart seller account is a quick process, taking less than 10
                                    minutes, and requires only 3 documents. Follow the checklist to ensure a seamless
                                    account creation experience. By having these documents ready, you can streamline the
                                    account creation process and get started on Electro-Kart as an online seller in no
                                    time.</p>
                            </div>
                    ...
                    <div class="styles__LeftContainer-a5s7uc-10 dMDvBv">
                        <div class="styles__Container-a5s7uc-5 bOSNXD">
                            <img src="https://static-assets-web.flixcart.com/fk-sp-static/images/prelogin/images/Desktop_2_sell.webp"
                                class="styles__Image-s6u1yz-6 eOqlUD">
                        </div>
            ...
            <div class="styles__StepsFlex-a5s7uc-12 jxcCkk">
                <div type="content-box" class="styles__Content-a5s7uc-13 ccYbZL">
                    <h4 class="styles__H4-a90kxg-4 styles__H4TextWrapper-a5s7uc-31 iJCgIp" style="color:#7971ea">Don’t
                        have a GSTIN?</h4>
                    <p class="styles__ParaTextWrapper-a5s7uc-33 iSVwyd">Follow the steps below to generate for your
                        online business.</p>
                    <div id="container">
                        <div class="box styles__Item-a5s7uc-15 cswvlQ">
                            ...
                            <span class="styles__SpanWrap-a5s7uc-16 dTSKYW">Register / Login to <a
                                    href="https://www.gst.gov.in/">www.gst.gov.in</a></span>
                        </div>

                        <div class="box styles__Item-a5s7uc-15 cswvlQ">
                            <img
                                src="https://static-assets-web.flixcart.com/fk-sp-static/images/prelogin/icons/FileSvg.svg">
                            <span class="styles__SpanWrap-a5s7uc-16 dTSKYW">Fill in the <a
                                    href="https://gstregistration.org/">GST Enrolment Application Form</a></span>
                        </div>
            ...
            <p style="font-size: 16px; font-weight: 300;" class="styles__ParaTextWrapper-a5s7uc-33 iHzMpX">
                Electro-Kart offers a diverse range of over 10+ categories where you can sell your products. These
                categories represent just a fraction of the wide variety available on Electro-Kart, providing ample
                opportunities for sellers to showcase their products to a large customer base.
            </p>
        </div>
    </div>
    </div>

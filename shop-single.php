...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addToCart'])) {
  if(isset($_POST['productId']) && isset($_POST['quantity'])){
    ...
    $username = $_SESSION['username']; // Update this line accordingly

    $sql = "INSERT INTO cart (product_id, quantity, username) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('iis', $productId, $quantity, $username);
...
if (isset($_GET['show'])) {
  ...
  if (!empty($productData['data'])) {
    ...
    // Assigning values from product data to variables
    ...
    // HTML form to select quantity and add to cart
    ?>

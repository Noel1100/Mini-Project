...
<head>
  ...
  <style>
    ...
    /* Add styles for the rounded border image */
    .rounded-image {
      border-radius: 20px;
      /* Adjust the border radius to your preference */
      overflow: hidden;
      /* Clip the image to the rounded border */
      display: inline-block;
    }

    /* Add animation for sliding from right to left */
    .slide-from-right {
      opacity: 0;
    ...
    /* Add staggered animation delay for each word */
